...
## The Project
The lab has built a tool called RASP30 which allows for graphical circuit design using Scilab Xcos and a custom library. We have also built a pipeline that centers around a custom Python-based HDL. I am currently building a circuit library for audio synthesis and signal processing, testing, tuning, and debugging on the FPAA.
